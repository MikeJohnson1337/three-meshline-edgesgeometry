...
declare namespace THREE {
   ...
   // custom blending src factors
    ...
    export class WebGLColorBuffer {
        ...
        setMask(colorMask: number | boolean): void;
    ...
    export class WebGLDepthBuffer {
        ...
        setMask(depthMask: number | boolean): void;
    ...
    export class WebGLStencilBuffer {
        ...
        setMask(stencilMask: number | boolean): void;
        setFunc(stencilFunc: Function | number, stencilRef: any, stencilMask: number): void;
